...
export default function IntroPost({ intro }){
    return (
        ...
        <div id='IntroPost'>
            <div id='Intro' 
                    className="flex flex-col gap-10  px-20">
            <div id='IntroText'>
            ...
            <img id="IntroImg" className="pt-10 rounded-lg scale-90 -mt-20" src={intro.photo}></img>
            <div id='SecondIntroText' 
                    className="flex flex-wrap gap-8  lg:px-52 md:px-32  text-black text-l text-[20px] font-[500] tracking-tight w-11/12 h-full lg:ml-10 pb-10">
            ...
            <div id='SecondaryPics' 
                    className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-rows-1 gap-8 lg:h-dvh w-full lg:-mb-20">
            ...
            <div id='LastIntroText' 
                    className="flex flex-col gap-6 lg:pb-12 lg:px-52 md:px-32 text-black text-[20px] font-[500] tracking-tight w-10/12 h-full -mt-11 lg:ml-20">
