...
export default function IntroPost({ intro }){
    return (
        ...
        <div id='introPost'>
            ...
            <div id='SecondIntroText' className="flex flex-wrap gap-8  lg:px-52 md:px-32  text-black text-l text-[20px] font-[500] tracking-tight w-11/12 h-full lg:ml-10 pb-10">
