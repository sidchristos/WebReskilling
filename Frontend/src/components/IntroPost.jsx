...
export default function IntroPost({ intro }){
    return (
        ...
        <div className="introPost">
            ...
            <div className="flex flex-wrap gap-8  lg:px-52 md:px-32  text-black text-l text-[20px] font-[500] tracking-tight w-11/12 h-full">
            ...
            <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-rows-1 gap-8 lg:h-dvh w-full ">
            ...
            <div className="flex flex-col gap-6 lg:pb-12 lg:px-52 md:px-32 text-black text-[20px] font-[500] tracking-tight w-10/12 h-full -mt-11">
